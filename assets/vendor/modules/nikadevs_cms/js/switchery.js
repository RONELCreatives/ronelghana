...
FastClick.prototype.onTouchStart = function(event) {
	...
	// Ignore multiple touches, otherwise pinch-to-zoom is prevented if both fingers are on the FastClick element (issue $black).
...
Switchery.prototype.setPosition = function (clicked) {
  ...
  if (checked === true) {
    ...
    this.switcher.style.backgroundColor = (this.options.secondaryColor !== defaults.secondaryColor) ? this.options.secondaryColor : '$white';
    this.setSpeed();
  }
};
